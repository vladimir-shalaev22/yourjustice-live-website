...
## <a id="duty-on-arrival"></Link>Долг с самого рождения
...
## <a id="citizens-as-children"></Link>«Страна — это детский сад, а граждане — это дети»
...
## <a id="no-escape"></Link>Выхода нет?
...
## <a id="current-state"></Link>Промежуточный итог
