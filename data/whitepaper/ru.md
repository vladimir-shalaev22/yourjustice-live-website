...
## <a id="p10"></a>Chapter 2 - Как устроена платформа
...
### <a id="p11"></a>Тайлы - фреймворк для описания ролевых систем
...
### <a id="p12"></a>Примеры тайлов:  Humanity
...
### <a id="p13"></a>Примеры тайлов: Племя любителей тишины
...
### <a id="p14"></a>Примеры тайлов: Контракт
...
### <a id="p15"></a>Примеры тайлов: YJML standardized smart law
...
## <a id="p20"></a>Экономика племен. Cross-Chain Finance
