...
## <a id="how-the-platform-works"></a>Chapter 2 - Как устроена платформа
...
Права роли:
    ...
    - sendJudgeProposal Разрешать спорные вопросы подавших в суд жителей племени
...
Права роли:
    ...
    - hargeNoizeMaker Выставить штраф жителю племени за превышение уровня децибел, который принят племенем как недопустимый
...
Actions, которые может выполнять роль:
    ...
    - stakeMilestone Положить на контракт сумму денег, необходимую для Milestone
    - closeMilestone Отправить исполнителю сумму денег, лежащую на контракте, и получить от него авторские права на работу
    - reviewContractor Оставить отзыв исполнителю, повысив или понизив ему рейтинг
    - callMediator Передать контракт в управление медиатору
    - reviewMediator Оставить отзыв медиатору, повысив или понизив ему рейтинг
    - eaveContract Выйти из контракта, отправить деньги исполнителю

2. **Исполнитель**
Actions, которые может выполнять роль:
    - fillContract заполнить в контракте условия, на которых он готов выполнить услугу
    - setMilestone Прописать ожидаемый результат шага и условия, при которых этот результат будет считаться достигнутым
    - sendMilestoneResult Отправить готовый результат майлстоуна на контракт, чтобы заказчик мог с ним ознакомиться
    - reviewClient Оставить отзыв заказчику, повысив или понизив ему рейтинг
    - callMediator Передать контракт в управление медиатору
    - reviewMediator Оставить отзыв медиатору, повысив или понизив ему рейтинг
...
### <a id="standardized-smart-law"></a>Примеры тайлов: YJML standardized smart law
...
## <a id="cross-chain-finance"></a>Экономика племен. Cross-Chain Finance
